...
export default function Home() {
    return (
        ...
        >
            <Header/>
            <PackageSlider noOfCards={3} title="Top Destinations" tagFilter="best-seller"/>
            <PackageSlider noOfCards={3} title="Hot Deals" tagFilter="sale"/>
            <PackageSlider noOfCards={3} title="Featured Packages" tagFilter="featured"/>
            <Services/>
            <Subscribe/>
        </Flex>
    );
